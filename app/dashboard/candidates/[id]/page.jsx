...
<div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mt-8">
  ...
  <div className="p-8">
    ...
    <div className="grid lg:grid-cols-2 gap-5">
      ...
      <InfoCard icon={<User size={18}/>} label="Full Name" value={candidate.fullName} />

      <InfoCard icon={<Users size={18}/>} label="Gender" value={candidate.gender} />
      ...
      <InfoCard icon={<BadgeCheck size={18}/>} label="Marital Status" value={candidate.maritalStatus} />

      <InfoCard icon={<MapPin size={18}/>} label="Address" value={candidate.address} />

      <InfoCard icon={<GraduationCap size={18}/>} label="Qualification" value={candidate.highestQualification} />

      <InfoCard icon={<CircleUserRound size={18}/>} label="University" value={candidate.university} />

      <InfoCard icon={<CalendarDays size={18}/>} label="Passing Year" value={candidate.passingYear} />

      <InfoCard icon={<BadgeCheck size={18}/>} label="Percentage" value={candidate.percentage} />

      <InfoCard icon={<Laptop size={18}/>} label="Software Skills" value={candidate.softwareKnowledge?.join(", ")} />

      <InfoCard icon={<Building2 size={18}/>} label="Previous Company" value={candidate.previousCompany} />

      <InfoCard icon={<BriefcaseBusiness size={18}/>} label="Designation" value={candidate.previousDesignation} />

      <InfoCard icon={<Users size={18}/>} label="Experience" value={candidate.experienceYears + " Years"} />

      <InfoCard icon={<IndianRupee size={18}/>} label="Last Salary" value={`₹ ${candidate.lastSalary}`} />
